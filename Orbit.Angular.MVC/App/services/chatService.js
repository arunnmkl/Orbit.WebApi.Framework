app.factory('chatService', ['localStorageService', '$http', 'AppSettings', function (localStorageService, $http, AppSettings) {
    ...
    var init = function () {
        ...
        $.connection.hub.url = AppSettings.chatBaseUri + AppSettings.chatBasePath;
